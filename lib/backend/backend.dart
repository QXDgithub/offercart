...
import 'schema/foodoffers_record.dart';
...
export 'schema/foodoffers_record.dart';
...
/// Functions to query FoodoffersRecords (as a Stream and as a Future).
Future<int> queryFoodoffersRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      FoodoffersRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<FoodoffersRecord>> queryFoodoffersRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      FoodoffersRecord.collection,
      FoodoffersRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<FoodoffersRecord>> queryFoodoffersRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
